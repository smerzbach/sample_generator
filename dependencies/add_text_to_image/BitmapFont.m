...
mfname = fileparts(mfilename('fullpath'));
matname = sprintf('Name_%s_Size_%d_Padding_%f.mat', Name, Size, Padding);
matname = fullfile(mfname, matname);
